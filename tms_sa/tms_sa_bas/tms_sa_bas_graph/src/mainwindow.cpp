...
public:
    ...
    {
        QString qsYLabel[8] = { "lost", "walking", "standing", "near chair",
                                "sitting on chair", "sitting on bed", "on bed", ""};
        if(value >= 0 && value <= 7)
    ...
    , qNode(argc,argv)
{
    ...
    qwtCurveBehaviorWalking->setSymbol(new QwtSymbol(QwtSymbol::Ellipse, QBrush(Qt::blue),QPen(Qt::blue,1),QSize(1,1)));
    ...
    qwtCurveBehaviorSleeping->setSymbol(new QwtSymbol(QwtSymbol::Ellipse,QBrush(Qt::darkGreen),QPen(Qt::darkGreen,1),QSize(1,1)));
    ...
    qwtCurveBehaviorMerged->setSymbol(new QwtSymbol(QwtSymbol::Ellipse,QBrush(Qt::black),QPen(Qt::black,1),QSize(1,1)));
