...
JNIEXPORT void JNICALL Java_com_github_irvs_ros_1tms_tms_1ur_tms_1ur_1arviewer_urclientactivity_ARToolkitDrawer_decodeYUV420SP(JNIEnv * env, jobject obj, jintArray rgb, jbyteArray yuv420sp, jint width, jint height, jint type)
{
    void *in, *out;
    int psz = getpagesize();
    int header_size;
