...
public:
  ...
  inline TagData() {}
  inline TagData(const TagData& _s)
    : _CORBA_Unbounded_Sequence_Octet(_s) {}

  inline TagData(_CORBA_ULong _max)
...
public:
  ...
  inline TagData_var(const TagData_var& _s) {
    if( _s._pd_seq )  _pd_seq = new TagData(*_s._pd_seq);
    else              _pd_seq = 0;
  }
  inline ~TagData_var() { if( _pd_seq )  delete _pd_seq; }
  ...
  inline TagData_var& operator = (const TagData_var& _s) {
    if( _s._pd_seq ) {
      if( !_pd_seq )  _pd_seq = new TagData;
      *_pd_seq = *_s._pd_seq;
    } else if( _pd_seq ) {
      delete _pd_seq;
      _pd_seq = 0;
  ...
  inline TagData* operator -> () { return _pd_seq; }
  inline const TagData* operator -> () const { return _pd_seq; }
#if defined(__GNUG__)
  inline operator TagData& () const { return *_pd_seq; }
#else
  inline operator const TagData& () const { return *_pd_seq; }
  inline operator TagData& () { return *_pd_seq; }
#endif
    
  inline const TagData& in() const { return *_pd_seq; }
  inline TagData&       inout()    { return *_pd_seq; }
  inline TagData*&      out() {
    if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
    return _pd_seq;
  }
  inline TagData* _retn() { TagData* tmp = _pd_seq; _pd_seq = 0; return tmp; }
...
class TagData_out {
public:
  inline TagData_out(TagData*& _s) : _data(_s) { _data = 0; }
  inline TagData_out(TagData_var& _s)
    : _data(_s._pd_seq) { _s = (TagData*) 0; }
  ...
  inline operator TagData*&()  { return _data; }
  inline TagData*& ptr()       { return _data; }
  inline TagData* operator->() { return _data; }
...
#define __Tag_mReaderWriter__
  ...
  public:
    ...
    ::CORBA::Boolean ISOWrite(::CORBA::Long blockAddr, ::CORBA::Long blockNum, const ::TagData& data, const ::TagData& uid);
    ...
    inline _objref_ReaderWriter()  { _PR_setobj(0); }  // nil
  ...
  public:
    ...
    virtual ::CORBA::Boolean ISORead(::CORBA::Long blockAddr, ::CORBA::Long blockNum, ::TagData_out data, const ::TagData& uid) = 0;
    virtual ::CORBA::Boolean ISOWrite(::CORBA::Long blockAddr, ::CORBA::Long blockNum, const ::TagData& data, const ::TagData& uid) = 0;
...
_CORBA_MODULE POA_Tag
_CORBA_MODULE_BEG

  class ReaderWriter :
    public virtual Tag::_impl_ReaderWriter,
