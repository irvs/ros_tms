...
//------------------------------------------------------------------------------
Client::Client() : bInitialize(false), orb(NULL), CommandObj_Vehicle(NULL), CommandObj_ArmR(NULL), CommandObj_ArmL(NULL), CommandObj_GripperR(NULL), CommandObj_GripperL(NULL), CommandObj_Lumbar(NULL)
{
	corbaS1 = 0;	corbaS2 = 0;
