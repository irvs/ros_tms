...
int8_t Client::vehicleGetState()
{
    ...
    switch (state) {
    case 0x010: ret = Ready;    printf("State: Ready\n");           break;
    case 0x011: ret = Busy;     printf("State: Busy\n");            break;
    case 0x013: ret = Alarm;    printf("State: Alarm\n");           break;
    case 0x014: ret = Stuck;    printf("State: Stuck\n");           break;
    case 0x015: ret = Paused;   printf("State: Paused\n");          break;
    case 0x017: ret = Locked;   printf("State: Locked\n");          break;
    case 0x018: ret = Powered;  printf("State: Powered\n");         break;
    case 0x019: ret = Unpowered;printf("State: Unpowered\n");       break;
    case 0x01A: ret = Caution;  printf("State: Caution\n");         break;
...
int8_t Client::vehicleMoveCruiseRel(double x_mm, double y_mm)
{
    ...
    if(ret) return  1;  // OK (Success)
    else    return -1;  // NG (Failure)
}
