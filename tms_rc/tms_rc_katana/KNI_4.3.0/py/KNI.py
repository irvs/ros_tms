...
class TMovement(_object):
    ...
    if _newclass:
        transition = _swig_property(
            _KNI.TMovement_transition_get, _KNI.TMovement_transition_set)
    __swig_setmethods__["velocity"] = _KNI.TMovement_velocity_set
    __swig_getmethods__["velocity"] = _KNI.TMovement_velocity_get
    if _newclass:
        velocity = _swig_property(
            _KNI.TMovement_velocity_get, _KNI.TMovement_velocity_set)
    ...
    if _newclass:
        acceleration = _swig_property(
            _KNI.TMovement_acceleration_get, _KNI.TMovement_acceleration_set)
