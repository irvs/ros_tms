...
/*!
  ...
  @brief Constructor.
*/
Clik::Clik(const Robot &robot_, const DiagonalMatrix &Kp_, const DiagonalMatrix &Ko_, const Real eps_,
           const Real lambda_max_, const Real dt_)
  : dt(dt_), eps(eps_), lambda_max(lambda_max_), robot(robot_)
{
  robot_type = CLICK_DH;
...
/*!
  ...
  @brief Constructor.
*/
Clik::Clik(const mRobot &mrobot_, const DiagonalMatrix &Kp_, const DiagonalMatrix &Ko_, const Real eps_,
           const Real lambda_max_, const Real dt_)
  : dt(dt_), eps(eps_), lambda_max(lambda_max_), mrobot(mrobot_)
{
...
/*!
  ...
  @brief Constructor.
*/
Clik::Clik(const mRobot_min_para &mrobot_min_para_, const DiagonalMatrix &Kp_, const DiagonalMatrix &Ko_,
           const Real eps_, const Real lambda_max_, const Real dt_)
  : dt(dt_), eps(eps_), lambda_max(lambda_max_), mrobot_min_para(mrobot_min_para_)
{
...
int Clik::endeff_pos_ori_err(const ColumnVector &pd, const ColumnVector &pdd, const Quaternion &qqqd,
...
void Clik::q_qdot(const Quaternion &qd, const ColumnVector &pd, const ColumnVector &pdd, const ColumnVector &wd,
