...
//------------------------------------------------------------------------------
bool pSetOdom(tms_msg_rc::tms_rc_ppose::Request  &req,
        tms_msg_rc::tms_rc_ppose::Response &res)
{
  bool ret = true;
...
//------------------------------------------------------------------------------
bool pMove(tms_msg_rc::tms_rc_pmove::Request &req,
		tms_msg_rc::tms_rc_pmove::Response &res)
{
  bool ret = true;
...
//------------------------------------------------------------------------------
bool kMoveAngleArray(tms_msg_rc::katana_pos_array::Request &req,
		tms_msg_rc::katana_pos_array::Response &res)
{
  bool ret = true;
...
//------------------------------------------------------------------------------
void RobotDataUpdate() { // for kxp_1(2006) 計算用モデル
...
//------------------------------------------------------------------------------
void RobotDataUpdate2() { // for kxp2 表示用モデル
	ros::Rate loop_rate(10); // 10Hz frequency (0.1 sec)
