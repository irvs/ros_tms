...
void laser_visualization_callback5(const sensor_msgs::LaserScan::ConstPtr &scan)
{
  visualization_msgs::MarkerArray markerArray;

  double laser_x     = Config::is()->lrf5_pos[0];
  double laser_y     = Config::is()->lrf5_pos[1];
  double laser_theta = Config::is()->lrf5_pos[2];
  double laser_point_x;
  double laser_point_y;
...
int main(int argc, char **argv)
{
  ...
  pub5 = n.advertise< visualization_msgs::MarkerArray >("laser_visualization5", 1);
  ...
  sub5 = n.subscribe("/LaserTracker5", 1, laser_visualization_callback5);
  ros::spin();
  return 0;
}
