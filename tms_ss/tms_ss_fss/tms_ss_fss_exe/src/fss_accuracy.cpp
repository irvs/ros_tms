...
float fAverageDistance[5]  = {0.0,};
float fAverageIntensity[5] = {0.0,};

float fVarianceDistance[5]  = {0.0,};
float fVarianceIntensity[5] = {0.0,};

float fStandardDeviationDistance[5]  = {0.0,};
float fStandardDeviationIntensity[5] = {0.0,};
