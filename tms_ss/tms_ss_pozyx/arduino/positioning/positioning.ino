...
int32_t anchors_x[8] = {6498, 9786,11058, 4834, 14738, 14643, 4536, 11266};               // anchor x-coorindates in mm
int32_t anchors_y[8] = {6181, 5781, 117, 117, 5553, 357, 2830, 2825};                  // anchor y-coordinates in mm
int32_t heights[8] = {2425, 2525, 2320, 2365, 2505, 2375, 2340, 2380};              // anchor z-coordinates in mm
