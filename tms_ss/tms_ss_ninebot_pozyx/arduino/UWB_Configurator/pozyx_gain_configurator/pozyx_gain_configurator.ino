...
// uint16_t devices[num_devices] = {0x0000, 0x6e39, 0x6e22, 0x6050, 0x6044, 0x6037, 0x6023, 0x6e30, 0x6e31, 0x6e58, 0x6e08, 0x6e23, 0x6e49};

const int num_devices = 6;
uint16_t devices[num_devices] = {0x0000, 0x6050, 0x6044, 0x6037, 0x6023, 0x6e04};
