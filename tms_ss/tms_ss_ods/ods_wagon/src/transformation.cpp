...
int main()
{
    ...
    t(0,0) =  sin(robot_theta);     t(0,1) = -sin(camera_pitch)*cos(robot_theta);   t(0,2) = cos(camera_pitch)*cos(robot_theta);
    t(1,0) = -cos(robot_theta);     t(1,1) = -sin(camera_pitch)*sin(robot_theta);   t(1,2) = cos(camera_pitch)*sin(robot_theta);
