...
int main ()
{
    ...
    for(double z=-0.010;z<0.780;z+=0.005){
        for(double y=-0.020;y<0.460;y+=0.005){
    		for(double x=-0.020;x<0.430;x+=0.005){
    			...
    			//足間の丸棒
    			if((((0.005 + 0.04545*(y-0.055)) <= x) && (x <= (0.020 + 0.04545*(y-0.055)))) || (((0.390 - 0.04545*(y-0.055)) <= x) && (x <= (0.405 - 0.04545*(y-0.055))))){
    				if((0.134 <= z) && (z <= 0.150)){
    					if((0.050 <= y) && (y <= 0.400)){
    						i=1;
    					}
    			...
    			//座面下の横枠
    			if((((0.000 + 0.04545*(y-0.055)) <= x) && (x <= (0.025 + 0.04545*(y-0.055)))) || (((0.385 - 0.04545*(y-0.055)) <= x) && (x <= (0.410 - 0.04545*(y-0.055))))){
    				if((0.305 <= z) && (z <= 0.370)){
    					if((0.055 <= y) && (y <= 0.385)){
    						i=1;
    					}
    			...
    			if(((-0.020 + 0.075*(y + 0.010)) <= x) && (x <= (0.430 - 0.075*(y + 0.010)))){
    				if((x - (-0.020 + 0.075*(y + 0.010))) < dis) dis = x - (-0.020 + 0.075*(y + 0.010));
    				if(((0.430 - 0.075*(y + 0.010)) - x) < dis) dis = (0.430 - 0.075*(y + 0.010)) -x;
    				if((y + 0.010) < dis) dis = (y + 0.010);
                    if((0.380 - y) < dis) dis = (0.380 - y);
    				if(dis <= 0.030){
    			...
    			if((0.040 <= x) && (x <= 0.370)){
                    if(((0.680 + 0.0909*(fabs(0.205 - x))) <= z) && (z <= 0.770)){
    					if(((0.42 - 0.0909*(fabs(0.205 - x))+ 0.166667*(z-0.660)) <= y) && (y <= (0.44 - 0.0909*(fabs(0.205 - x))+ 0.166667*(z-0.660)))){
    						i=1;
    					}
    				}
    			}
    ...
    r(0,0) = 1;  r(0,1) = 0;  r(0,2) = 0;  r(0,3) = -0.205;  
	r(1,0) = 0;  r(1,1) = 1;  r(1,2) = 0;  r(1,3) = -0.215;
    r(2,0) = 0;  r(2,1) = 0;  r(2,2) = 1;  r(2,3) = 0;
	r(3,0) = 0;  r(3,1) = 0;  r(3,2) = 0;  r(3,3) = 1;
	pcl::transformPointCloud (*cloud, *cloud, r); 
    
    pcl::io::savePCDFile("catkin_ws/src/ros_tms/tms_ss/tms_ss_ods/ods_make_model/data/chair/model_chair.pcd", *cloud, false);
