...
//**顔認識
//*******************************
int detectAndDraw( cv::Mat& img, cv::Mat& view, int cn,
                   cv::CascadeClassifier& cascade, cv::CascadeClassifier& nestedCascade, double scale)
{
    //変数宣言
    ...
    cascade.detectMultiScale(smallImg, faces, 1.3, 3, 0|CV_HAAR_FIND_BIGGEST_OBJECT/*|CV_HAAR_SCALE_IMAGE*/, cv::Size(40,40));
