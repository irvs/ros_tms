...
void FPFH_descriptors(pcl::PointCloud<pcl::PointXYZRGB>& cloud, pcl::PointCloud<pcl::PointXYZI>& keypoints, pcl::PointCloud<pcl::FPFHSignature33>& features)
{
    pcl::Feature<pcl::PointXYZRGB, pcl::FPFHSignature33>::Ptr feature_extractor (new pcl::FPFHEstimation<pcl::PointXYZRGB, pcl::Normal, pcl::FPFHSignature33>);
    ...
    feature_extractor->setSearchMethod(tree);//pcl::search::Search<pcl::PointXYZRGB>::Ptr (new pcl::search::KdTree<pcl::PointXYZRGB>()));
...
void find_correspondences(pcl::PointCloud<pcl::FPFHSignature33>& features1, pcl::PointCloud<pcl::FPFHSignature33>& features2, std::vector<int>& correspondences)
{
...
void filter_correspondences(pcl::PointCloud<pcl::PointXYZI>& keypoints1, pcl::PointCloud<pcl::PointXYZI>& keypoints2, std::vector<int>& correspondences1, std::vector<int>& correspondences2, pcl::CorrespondencesPtr correspondences)
{
...
Eigen::Matrix4f initial_transformation(pcl::PointCloud<pcl::PointXYZI>& keypoints1, pcl::PointCloud<pcl::PointXYZI>& keypoints2, pcl::CorrespondencesPtr correspondences,
                            pcl::PointCloud<pcl::PointXYZRGB>& cloud1, pcl::PointCloud<pcl::PointXYZRGB>& cloud2, pcl::PointCloud<pcl::PointXYZRGB>& transformed)
{
    ...
    transformation_estimation->estimateRigidTransformation (keypoints1, keypoints2, *correspondences, initial_transformation_matrix_);
    pcl::transformPointCloud(cloud1, transformed, initial_transformation_matrix_);

    return initial_transformation_matrix_;
}

/*Eigen::Matrix4f final_transformation(pcl::PointCloud<pcl::PointXYZRGB>& transformed, pcl::PointCloud<pcl::PointXYZRGB>& registered, pcl::PointCloud<pcl::PointXYZRGB>& cloud)
{
...
int main(int argc, char** argv){
    ...
    pcl::io::savePCDFile("src/ods_correspondence_estimation/data/ods_correspondence_estimation/keypoints1.pcd", *keypoints1);
    pcl::io::savePCDFile("src/ods_correspondence_estimation/data/ods_correspondence_estimation/keypoints2.pcd", *keypoints2);
    ...
    pcl::io::savePCDFile("src/ods_correspondence_estimation/data/ods_correspondence_estimation/features1.pcd", *features1);
    pcl::io::savePCDFile("src/ods_correspondence_estimation/data/ods_correspondence_estimation/features2.pcd", *features2);
    ...
    pcl::io::savePCDFile("src/ods_correspondence_estimation/data/ods_correspondence_estimation/corr_cloud1.pcd", *corr_cloud1);
    pcl::io::savePCDFile("src/ods_correspondence_estimation/data/ods_correspondence_estimation/corr_cloud2.pcd", *corr_cloud2);

    //Initial transformation
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr transformed (new pcl::PointCloud<pcl::PointXYZRGB>);
    Eigen::Matrix4f initial_transformation_matrix = initial_transformation(*keypoints1, *keypoints2, correspondences, *cloud1, *cloud2, *transformed);

    *transformed += *cloud2;

    pcl::io::savePCDFile("src/ods_correspondence_estimation/data/ods_correspondence_estimation/transformed.pcd", *transformed);
