...
//
//***********************************************
void segmentation(pcl::PointCloud<pcl::PointXYZRGB>& cloud, pcl::PointCloud<pcl::PointXYZHSV>& hsv, std::vector<object_map>& map)
{
...
void compare_histogram(object_map object1, object_map object2)
{
    ...
    max2.value = 1000000;   max2.value = 1000000;
