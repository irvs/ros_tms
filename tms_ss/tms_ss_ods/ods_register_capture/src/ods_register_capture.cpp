...
int main(int argc, char **argv)
{
    ...
    t1(0,0) = sin(robot_theta);    t1(0,1) = -sin(camera_yaw)*cos(robot_theta);    t1(0,2) = cos(camera_yaw)*cos(robot_theta);    t1(0,3) = camera_x;
    t1(1,0) = -cos(robot_theta);    t1(1,1) = -sin(camera_yaw)*sin(robot_theta);     t1(1,2) = cos(camera_yaw)*sin(robot_theta);     t1(1,3) = camera_y;
