...
int main(int argc, char **argv)
{
    ...
    *model6 = *model5;
    ...
    t1(0,0) = 1;  t1(0,1) = 0;   t1(0,2) = 0;  t1(0,3) = 1.4;
    t1(1,0) = 0;  t1(1,1) = -1;  t1(1,2) = 0;  t1(1,3) = 1.9;
    t1(2,0) = 0;  t1(2,1) = 0;   t1(2,2) = -1;  t1(2,3) = 0.7;
    ...
    t2(0,0) = 0;  t2(0,1) = 1;  t2(0,2) = 0;  t2(0,3) = 4.23;
    t2(1,0) = 1;  t2(1,1) = 0;  t2(1,2) = 0;  t2(1,3) = 2.25;
    t2(2,0) = 0;  t2(2,1) = 0;  t2(2,2) = -1;  t2(2,3) = 0.75;
    ...
    t3(0,0) = 0;  t3(0,1) = 0;  t3(0,2) = 1;  t3(0,3) = 3.925;
    t3(1,0) = -1;  t3(1,1) = 0;  t3(1,2) = 0;  t3(1,3) = 1.41;
    t3(2,0) = 0;  t3(2,1) = -1;  t3(2,2) = 0;  t3(2,3) = 0.91;
    ...
    t4(0,0) = 0;  t4(0,1) = 0;  t4(0,2) = 1;  t4(0,3) = 3.99;
    t4(1,0) = -1;  t4(1,1) = 0;  t4(1,2) = 0;  t4(1,3) = 0.15;
    t4(2,0) = 0;  t4(2,1) = -1;  t4(2,2) = 0;  t4(2,3) = 1.81;
    ...
    t5(0,0) = -1;  t5(0,1) = 0;  t5(0,2) = 0;  t5(0,3) = 1.4;
    t5(1,0) = 0;  t5(1,1) = 1;  t5(1,2) = 0;  t5(1,3) = 2.6;
    t5(2,0) = 0;  t5(2,1) = 0;  t5(2,2) = -1;  t5(2,3) = 0.43;
    ...
    t6(0,0) = 0;  t6(0,1) = -1;  t6(0,2) = 0;  t6(0,3) = 3.9;
    t6(1,0) = -1;  t6(1,1) = 0;  t6(1,2) = 0;  t6(1,3) = 2.25;
    t6(2,0) = 0;  t6(2,1) = 0;  t6(2,2) = -1;  t6(2,3) = 0.43;
    t6(3,0) = 0;  t6(3,1) = 0;  t6(3,2) = 0;  t6(3,3) = 1;

    pcl::transformPointCloud(*model6, *model6, t6);

    Eigen::Matrix4f t7(Eigen::Matrix4f::Identity());

    t7(0,0) = 0;  t7(0,1) = 1;  t7(0,2) = 0;  t7(0,3) = 3.5;
    t7(1,0) = -1;  t7(1,1) = 0;  t7(1,2) = 0;  t7(1,3) = 3.5;
    t7(2,0) = 0;  t7(2,1) = 0;  t7(2,2) = 1;  t7(2,3) = 0;
    t7(3,0) = 0;  t7(3,1) = 0;  t7(3,2) = 0;  t7(3,3) = 1;
