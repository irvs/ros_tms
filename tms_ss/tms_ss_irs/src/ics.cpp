//------------------------------------------------------------------------------
// @file   : ics.cpp
// @brief  : Intelligent Cabinet System
// @author : Koji Murakami, Kusaka Kazuya, Yoonseok Pyo
...
int main(int argc, char** argv)
{
 ...
 //  }
  ...
  int32_t idSensor = 3018; // irs
  int32_t idPlace  = 2009; // refrigerator (irs) >> 928_foor >> 928_room

	ros::init(argc, argv, "irs");
