...
namespace gazebo
{
  ...
  public:
		...
		void OnUpdate(const common::UpdateInfo &)
		{
			...
			{
				time = 0;
				if(angle_l[0] > angle_buf_l[0]) angle_l[0] -=  0.01;
				if(angle_l[0] < angle_buf_l[0]) angle_l[0] +=  0.01;
				if(angle_l[1] > angle_buf_l[1]) angle_l[1] -=  0.01;
				if(angle_l[1] < angle_buf_l[1]) angle_l[1] +=  0.01;
				if(angle_l[2] > angle_buf_l[2]) angle_l[2] -=  0.01;
				if(angle_l[2] < angle_buf_l[2]) angle_l[2] +=  0.01;
				if(angle_l[3] > angle_buf_l[3]) angle_l[3] -=  0.01;
				if(angle_l[3] < angle_buf_l[3]) angle_l[3] +=  0.01;
				if(angle_l[4] > angle_buf_l[4]) angle_l[4] -=  0.01;
				if(angle_l[4] < angle_buf_l[4]) angle_l[4] +=  0.01;
				if(angle_l[5] > angle_buf_l[5]) angle_l[5] -=  0.01;
				if(angle_l[5] < angle_buf_l[5]) angle_l[5] +=  0.01;
				if(angle_l[6] > angle_buf_l[6]) angle_l[6] -=  0.01;
				if(angle_l[6] < angle_buf_l[6]) angle_l[6] +=  0.01;
				if(angle_l[7] > angle_buf_l[7]) angle_l[7] -=  0.01;
				if(angle_l[7] < angle_buf_l[7]) angle_l[7] +=  0.01;
			}
