    ...
    std::map<std::string, T> &out)
{
  ...
  else
  {
    ...
    T Teta_SL, Phi_SL, Teta_SL2, Teta_EL, Teta_SR, Phi_SR, Teta_SR2, Teta_ER, Teta_HL, Phi_HL, Teta_HL2, Teta_KL, Teta_HR, Phi_HR, Teta_HR2, Teta_KR, temp_x, temp_y, temp_z;
