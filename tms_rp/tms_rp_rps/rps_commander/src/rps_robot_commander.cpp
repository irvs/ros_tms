...
void sp5_commander(vector<tms_msg_rp::rps_pos_param> in_param_array)
{
	...
	for(int i=0;i<in_param_array.size()-1;i++){
		...
		if(move_flg){
			...
			cout<<"Move VEHICLE to	x:"<<srv_smartpal_control.request.arg[0]<<"	y:"<<srv_smartpal_control.request.arg[1]<<"	th:"<<srv_smartpal_control.request.arg[2]<<endl;
		...
		if(move_flg){
			...
			cout<<"Move LUMBA to	Low:"<<srv_smartpal_control.request.arg[0]<<"	High:"<<srv_smartpal_control.request.arg[1]<<endl;
		...
		if(move_flg){
			...
			cout<<"Move ARM_R to	j1:"<<srv_smartpal_control.request.arg[0]<<"	j2:"<<srv_smartpal_control.request.arg[1]<<"	j3:"<<srv_smartpal_control.request.arg[2]
				<<"	j4:"<<srv_smartpal_control.request.arg[3]<<"	j5:"<<srv_smartpal_control.request.arg[4]<<"	j6:"<<srv_smartpal_control.request.arg[5]<<"	j7:"<<srv_smartpal_control.request.arg[6]<<endl;
		...
		if(move_flg){
			...
			cout<<"Move ARM_L to	j1:"<<srv_smartpal_control.request.arg[0]<<"	j2:"<<srv_smartpal_control.request.arg[1]<<"	j3:"<<srv_smartpal_control.request.arg[2]
				<<"	j4:"<<srv_smartpal_control.request.arg[3]<<"	j5:"<<srv_smartpal_control.request.arg[4]<<"	j6:"<<srv_smartpal_control.request.arg[5]<<"	j7:"<<srv_smartpal_control.request.arg[6]<<endl;
