...
/////////GET WAGON POS FROM XTION///////////
	...
	cout<<"ods_Wagon	x:"<<ods_wagon.response.wagon.x<<"	y:"<<ods_wagon.response.wagon.y<<"	th:"<<ods_wagon.response.wagon.theta<<endl;
