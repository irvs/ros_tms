...
bool start_voronoi_path_planner(tms_msg_rp::rps_voronoi_path_planning::Request& req, tms_msg_rp::rps_voronoi_path_planning::Response& res)
{
	res.success = 0;
