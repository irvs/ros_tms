...
def main():
    ...
    with sm_root:
        ...
        smach.StateMachine.add('move0',
                               ServiceState('rp_cmd',
                                            rp_cmd,
                                            request=rp_cmdRequest(9001, False, 2003, [7004])),
        ...
        smach.StateMachine.add('grasp1',
                               ServiceState('rp_cmd',
                                            rp_cmd,
                                            request=rp_cmdRequest(9002, False, 2003, [7004])),
        ...
        smach.StateMachine.add('move2',
                               ServiceState('rp_cmd',
                                            rp_cmd,
                                            request=rp_cmdRequest(9001, False, 2003, [1002])),
        ...
        smach.StateMachine.add('release3',
                               ServiceState('rp_cmd',
                                            rp_cmd,
                                            request=rp_cmdRequest(9003, False, 2003, [1002])),
