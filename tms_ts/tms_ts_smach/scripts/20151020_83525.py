...
def main():
    ...
    with sm_root:
        ...
        smach.StateMachine.add('move0',
                           ServiceState('rp_cmd',
                                        rp_cmd,
                                        request = rp_cmdRequest(9001, True, 2003, [7001])),
        ...
        smach.StateMachine.add('grasp1',
                           ServiceState('rp_cmd',
                                        rp_cmd,
                                        request = rp_cmdRequest(9002, True, 2003, [7001])),
        ...
        smach.StateMachine.add('move2',
                           ServiceState('rp_cmd',
                                        rp_cmd,
                                        request = rp_cmdRequest(9001, True, 2003, [6017])),
        ...
        smach.StateMachine.add('control2',
                           ServiceState('ts_state_control',
                                        ts_state_control,
                                        request = ts_state_controlRequest(0, 0, 0, 0, "")),
                           transitions={'succeeded':'give3', 'aborted':'aborted'})

        smach.StateMachine.add('give3',
                           ServiceState('rp_cmd',
                                        rp_cmd,
                                        request = rp_cmdRequest(9003, True, 2003, [6017])),
